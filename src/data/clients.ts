...
export const clients: Client[] = [
  { name: 'Cafe Leo Teras', url: 'https://cafe-leo.onlinemenu-qr.com', logo: cafeLeo, alt: 'Cafe Leo Teras logosu', scale: 1.3 },
  { name: 'Leo Lounge', url: 'https://leo-lounge.onlinemenu-qr.com', logo: leoLounge, alt: 'Leo Lounge logosu', scale: 1.3 },
  { name: 'Sistem Simit Fırını', url: 'https://sistemsimitfirini.onlinemenu-qr.com', logo: sistemSimit, alt: 'Sistem Simit Fırını logosu' },
  // Kök adres 301 ile /menu/'ye yönleniyor; doğrudan hedefe bağlanıyoruz.
  { name: 'Sistem Pide & Lahmacun Fırını', url: 'https://sistemlahmacunfirini.onlinemenu-qr.com/menu/', logo: sistemLahmacun, alt: 'Sistem Pide & Lahmacun Fırını logosu' },
];
